Forked from https://github.com/teddy-lee/J8583CN

FAQ:
    * 为何重复上传此项目, 而不是直接fork?
        原项目整体编码为GBK, 使用时出现了些许不便. 此版更改编码为UTF-8, 由于pull request时太多文件被修改, 感觉不合适, 因此重新上传.

    * 与原版相比, 有何改动?
        首次commit时, 与原版的区别仅三条:
            - 修正: 当8583报文中存在中文时, 由于多字节造成的数组越界异常.
            - 新增: 指定8583报文中的中文编码.
            - 新增: date8字段.
        此版本早已在项目中投入使用, 目前尚未发现其他问题.
